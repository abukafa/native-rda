...
$pdf->Cell(0,0.7,'Draft Remunerasi',0,1,'C');
...
$pdf->Cell(0.5, 1.6, 'No', 1, 0, 'C');
$pdf->Cell(7, 0.8, 'Identitas', 1, 0, 'C');
$pdf->Cell(0.5, 1.6, '*', 1, 0, 'C', 1);
...
$pdf->Cell(0.5, 1.6, '*', 1, 0, 'C', 1);
$pdf->Cell(1.5, 1.6, 'Total', 1, 0, 'C');
$pdf->Cell(0, 0.8, '', 0, 1, 'C');

$pdf->Cell(0.5, 1.6, '', 0, 0, 'C');
$pdf->Cell(1.5, 0.8, 'Nama', 1, 0, 'C');
...
$pdf->SetFont('Arial','',8);
$pdf->Cell(0.5, 0.7, $no,1,0, 'L');
$pdf->Cell(1.5, 0.7, $s['PANGGILAN'],1,0, 'L');
...
$pdf->Cell(0.5, 0.7, substr($s['ACC'],0,1),1,0, 'C', 1);
...
$pdf->Cell(0.5, 0.7, substr($a['ACC'],0,1),1,0, 'C', 1);
...
$pdf->Cell(0.5, 0.7, substr($k['ACC'],0,1),1,0, 'C', 1);
...
$pdf->Cell(1.5, 0.7, number_format($t['T_PRG'],0,'.',','),1,0, 'R');
$pdf->Cell(1.5, 0.7, number_format($tlin,0,'.',','),1,0, 'R');
$pdf->Cell(0.5, 0.7, substr($t['ACC'],0,1),1,0, 'C', 1);
...
$pdf->Cell(0.5, 0.7, substr($p['ACC'],0,1),1,0, 'C', 1);
$pdf->Cell(1.5, 0.7, number_format($total,0,'.',','),1,1, 'R');		
...
$pdf->ln(0.1);
$pdf->Cell(9, 0.8, 'TOTAL', 1, 0, 'C');
$pdf->Cell(0.5, 0.8, '', 1, 0, 'R',1);
...
$pdf->Cell(0.5, 0.8, '', 1, 0, 'R',1);
$pdf->Cell(1.5, 0.8, number_format($tot,0,'.',','), 1, 1, 'R');
$pdf->Output("Draft Remun.pdf","I");
