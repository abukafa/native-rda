...
$tplin=0;
$tot=0;
$query=mysqli_query($GLOBALS["___mysqli_ston"], "select * from santri where STATUS_SANTRI='AKTIF' and STATUS_RDA<>'SUSPEND' and GRADE<>13 order by LAZNAH, NAMA");
...
$pdf->Cell(1.75, 0.7, number_format($total,0,'.',','),1,0, 'R');	
$pdf->Cell(1, 0.7, '',1,1, 'C');	
...
$pdf->Cell(1.75, 0.8, number_format($tot,0,'.',','), 1, 0, 'R');
$pdf->Cell(1, 0.8, '',1,1, 'C');	
